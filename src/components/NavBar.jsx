...
const NavBar = () => {
  ...
  return (
    ...
    <div>
      <h1 className="text-5xl font-signature ml-2">Kimutai</h1>
      </div>
      ...
      {links.map(({ id, link}) => (
       ...
       <div 
       onClick={() => setNav(!nav)}
         className="cursor-pointer pr-4 z-10 text-gray-500 first-letter 
         md:hidden"
         >
        ...
        {nav && (
         ...
         h-screen bg-gradient-to-b from-black to-gray-800  text-gra-500 ">
           {links.map(({ id, link}) => (
         <li 
          key={id}
